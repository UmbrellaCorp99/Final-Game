...
//No return
void status::drawStatus(int xOffset, int yOffset) {
...
//No return
void status::load_animated_status(int size, int WIDTH, int HEIGHT) {
	char s[80];
	maxframe = size;
	for (int n = 0; n < size; n++)
	{
		sprintf_s(s, "fine/frame_%d_delay-0.04s.png", n);
...
//This is a deconstructor for the status class
//takes no parameters
//No return
status::~status() {
